...
const file_recsys_v1_recsys_proto_rawDesc = "" +
	...
	"\x10SIGNAL_TYPE_SKIP\x10\a2\xd2\x02\n" +
	"\x15RecommendationService\x12@\n" +
	"\aGetFeed\x12\x19.recsys.v1.GetFeedRequest\x1a\x1a.recsys.v1.GetFeedResponse\x12F\n" +
	"\tGetUpNext\x12\x1b.recsys.v1.GetUpNextRequest\x1a\x1c.recsys.v1.GetUpNextResponse\x12O\n" +
...
var file_recsys_v1_recsys_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_recsys_v1_recsys_proto_goTypes = []any{
	...
	(*GetUpNextRequest)(nil),          // 5: recsys.v1.GetUpNextRequest
	(*GetUpNextResponse)(nil),         // 6: recsys.v1.GetUpNextResponse
	(*RecordSignalRequest)(nil),       // 7: recsys.v1.RecordSignalRequest
	(*RecordSignalResponse)(nil),      // 8: recsys.v1.RecordSignalResponse
	(*RecordImpressionsRequest)(nil),  // 9: recsys.v1.RecordImpressionsRequest
	(*RecordImpressionsResponse)(nil), // 10: recsys.v1.RecordImpressionsResponse
...
var file_recsys_v1_recsys_proto_depIdxs = []int32{
	...
	2,  // 2: recsys.v1.GetUpNextResponse.videos:type_name -> recsys.v1.RankedVideo
	1,  // 3: recsys.v1.RecordSignalRequest.type:type_name -> recsys.v1.SignalType
	11, // 4: recsys.v1.RecordSignalRequest.occurred_at:type_name -> google.protobuf.Timestamp
	3,  // 5: recsys.v1.RecommendationService.GetFeed:input_type -> recsys.v1.GetFeedRequest
	5,  // 6: recsys.v1.RecommendationService.GetUpNext:input_type -> recsys.v1.GetUpNextRequest
	7,  // 7: recsys.v1.RecommendationService.RecordSignal:input_type -> recsys.v1.RecordSignalRequest
	9,  // 8: recsys.v1.RecommendationService.RecordImpressions:input_type -> recsys.v1.RecordImpressionsRequest
	4,  // 9: recsys.v1.RecommendationService.GetFeed:output_type -> recsys.v1.GetFeedResponse
	6,  // 10: recsys.v1.RecommendationService.GetUpNext:output_type -> recsys.v1.GetUpNextResponse
	8,  // 11: recsys.v1.RecommendationService.RecordSignal:output_type -> recsys.v1.RecordSignalResponse
	10, // 12: recsys.v1.RecommendationService.RecordImpressions:output_type -> recsys.v1.RecordImpressionsResponse
