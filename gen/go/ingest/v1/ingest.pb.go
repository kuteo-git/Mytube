...
const file_ingest_v1_ingest_proto_rawDesc = "" +
	...
	"\x13JOB_STATE_CANCELLED\x10\x052\xe8\x11\n" +
	"\rIngestService\x12=\n" +
	...
	"\x0eFetchSubtitles\x12 .ingest.v1.FetchSubtitlesRequest\x1a!.ingest.v1.FetchSubtitlesResponse\x12R\n" +
...
var file_ingest_v1_ingest_proto_msgTypes = make([]protoimpl.MessageInfo, 64)
var file_ingest_v1_ingest_proto_goTypes = []any{
	...
	(*ResolveChannelRequest)(nil),        // 6: ingest.v1.ResolveChannelRequest
	(*ResolveChannelResponse)(nil),       // 7: ingest.v1.ResolveChannelResponse
	(*SetAccountCookiesRequest)(nil),     // 8: ingest.v1.SetAccountCookiesRequest
	(*SetAccountCookiesResponse)(nil),    // 9: ingest.v1.SetAccountCookiesResponse
	(*ListAccountsRequest)(nil),          // 10: ingest.v1.ListAccountsRequest
	(*ListAccountsResponse)(nil),         // 11: ingest.v1.ListAccountsResponse
	(*Account)(nil),                      // 12: ingest.v1.Account
	(*RemoveAccountRequest)(nil),         // 13: ingest.v1.RemoveAccountRequest
	(*RemoveAccountResponse)(nil),        // 14: ingest.v1.RemoveAccountResponse
	(*ScanAccountsRequest)(nil),          // 15: ingest.v1.ScanAccountsRequest
	(*GetAccountScanStatusRequest)(nil),  // 16: ingest.v1.GetAccountScanStatusRequest
	(*GetAccountScanStatusResponse)(nil), // 17: ingest.v1.GetAccountScanStatusResponse
	(*AccountScanStatus)(nil),            // 18: ingest.v1.AccountScanStatus
	(*ScanAccountsResponse)(nil),         // 19: ingest.v1.ScanAccountsResponse
	(*ExpandLibraryRequest)(nil),         // 20: ingest.v1.ExpandLibraryRequest
	(*ExpandLibraryResponse)(nil),        // 21: ingest.v1.ExpandLibraryResponse
	(*ExternalVideo)(nil),                // 22: ingest.v1.ExternalVideo
	(*SearchRequest)(nil),                // 23: ingest.v1.SearchRequest
	(*SearchResponse)(nil),               // 24: ingest.v1.SearchResponse
	(*PreviewVideoRequest)(nil),          // 25: ingest.v1.PreviewVideoRequest
	(*PreviewVideoResponse)(nil),         // 26: ingest.v1.PreviewVideoResponse
	(*EnsureVideoRequest)(nil),           // 27: ingest.v1.EnsureVideoRequest
	(*EnsureVideoResponse)(nil),          // 28: ingest.v1.EnsureVideoResponse
	(*BackfillTopicsRequest)(nil),        // 29: ingest.v1.BackfillTopicsRequest
	(*GetBackfillStatusRequest)(nil),     // 30: ingest.v1.GetBackfillStatusRequest
	(*BackfillStatus)(nil),               // 31: ingest.v1.BackfillStatus
	(*BackfillTopicsResponse)(nil),       // 32: ingest.v1.BackfillTopicsResponse
	(*GetBackfillStatusResponse)(nil),    // 33: ingest.v1.GetBackfillStatusResponse
	(*RefreshRequest)(nil),               // 34: ingest.v1.RefreshRequest
	(*RefreshResponse)(nil),              // 35: ingest.v1.RefreshResponse
	(*GetScanStatusRequest)(nil),         // 36: ingest.v1.GetScanStatusRequest
	(*GetScanStatusResponse)(nil),        // 37: ingest.v1.GetScanStatusResponse
	(*ScanStatus)(nil),                   // 38: ingest.v1.ScanStatus
	(*ResolveStreamRequest)(nil),         // 39: ingest.v1.ResolveStreamRequest
	(*ResolveStreamResponse)(nil),        // 40: ingest.v1.ResolveStreamResponse
	(*SubmitRequest)(nil),                // 41: ingest.v1.SubmitRequest
	(*SubmitResponse)(nil),               // 42: ingest.v1.SubmitResponse
	(*Job)(nil),                          // 43: ingest.v1.Job
	(*GetJobRequest)(nil),                // 44: ingest.v1.GetJobRequest
	(*GetJobResponse)(nil),               // 45: ingest.v1.GetJobResponse
	(*ListJobsRequest)(nil),              // 46: ingest.v1.ListJobsRequest
	(*ListJobsResponse)(nil),             // 47: ingest.v1.ListJobsResponse
	(*CancelJobRequest)(nil),             // 48: ingest.v1.CancelJobRequest
	(*CancelJobResponse)(nil),            // 49: ingest.v1.CancelJobResponse
	(*DismissJobRequest)(nil),            // 50: ingest.v1.DismissJobRequest
	(*DismissJobResponse)(nil),           // 51: ingest.v1.DismissJobResponse
	(*DismissJobsRequest)(nil),           // 52: ingest.v1.DismissJobsRequest
	(*DismissJobsResponse)(nil),          // 53: ingest.v1.DismissJobsResponse
	(*RetryJobRequest)(nil),              // 54: ingest.v1.RetryJobRequest
	(*RetryJobResponse)(nil),             // 55: ingest.v1.RetryJobResponse
	(*ListScansRequest)(nil),             // 56: ingest.v1.ListScansRequest
	(*ListScansResponse)(nil),            // 57: ingest.v1.ListScansResponse
	(*ClearScansRequest)(nil),            // 58: ingest.v1.ClearScansRequest
	(*ClearScansResponse)(nil),           // 59: ingest.v1.ClearScansResponse
	(*CancelVideoDownloadRequest)(nil),   // 60: ingest.v1.CancelVideoDownloadRequest
	(*CancelVideoDownloadResponse)(nil),  // 61: ingest.v1.CancelVideoDownloadResponse
	(*YouTubeComment)(nil),               // 62: ingest.v1.YouTubeComment
	(*FetchCommentsRequest)(nil),         // 63: ingest.v1.FetchCommentsRequest
	(*FetchCommentsResponse)(nil),        // 64: ingest.v1.FetchCommentsResponse
	(*timestamppb.Timestamp)(nil),        // 65: google.protobuf.Timestamp
}
var file_ingest_v1_ingest_proto_depIdxs = []int32{
	22, // 0: ingest.v1.ListChannelUploadsResponse.videos:type_name -> ingest.v1.ExternalVideo
	2,  // 1: ingest.v1.ListChannelUploadsResponse.sort_options:type_name -> ingest.v1.SortOption
	12, // 2: ingest.v1.ListAccountsResponse.accounts:type_name -> ingest.v1.Account
	65, // 3: ingest.v1.Account.added_at:type_name -> google.protobuf.Timestamp
	65, // 4: ingest.v1.Account.last_scan_at:type_name -> google.protobuf.Timestamp
	18, // 5: ingest.v1.GetAccountScanStatusResponse.status:type_name -> ingest.v1.AccountScanStatus
	65, // 6: ingest.v1.AccountScanStatus.started_at:type_name -> google.protobuf.Timestamp
	65, // 7: ingest.v1.ExternalVideo.published_at:type_name -> google.protobuf.Timestamp
	22, // 8: ingest.v1.SearchResponse.videos:type_name -> ingest.v1.ExternalVideo
	22, // 9: ingest.v1.PreviewVideoResponse.video:type_name -> ingest.v1.ExternalVideo
	65, // 10: ingest.v1.BackfillStatus.started_at:type_name -> google.protobuf.Timestamp
	65, // 11: ingest.v1.BackfillStatus.finished_at:type_name -> google.protobuf.Timestamp
	31, // 12: ingest.v1.BackfillTopicsResponse.status:type_name -> ingest.v1.BackfillStatus
	31, // 13: ingest.v1.GetBackfillStatusResponse.status:type_name -> ingest.v1.BackfillStatus
	38, // 14: ingest.v1.RefreshResponse.status:type_name -> ingest.v1.ScanStatus
	38, // 15: ingest.v1.GetScanStatusResponse.status:type_name -> ingest.v1.ScanStatus
	65, // 16: ingest.v1.ScanStatus.started_at:type_name -> google.protobuf.Timestamp
	65, // 17: ingest.v1.ResolveStreamResponse.expires_at:type_name -> google.protobuf.Timestamp
	43, // 18: ingest.v1.SubmitResponse.job:type_name -> ingest.v1.Job
	0,  // 19: ingest.v1.Job.state:type_name -> ingest.v1.JobState
	65, // 20: ingest.v1.Job.created_at:type_name -> google.protobuf.Timestamp
	65, // 21: ingest.v1.Job.finished_at:type_name -> google.protobuf.Timestamp
	43, // 22: ingest.v1.GetJobResponse.job:type_name -> ingest.v1.Job
	43, // 23: ingest.v1.ListJobsResponse.jobs:type_name -> ingest.v1.Job
	43, // 24: ingest.v1.RetryJobResponse.job:type_name -> ingest.v1.Job
	38, // 25: ingest.v1.ListScansResponse.scans:type_name -> ingest.v1.ScanStatus
	62, // 26: ingest.v1.FetchCommentsResponse.comments:type_name -> ingest.v1.YouTubeComment
	23, // 27: ingest.v1.IngestService.Search:input_type -> ingest.v1.SearchRequest
	27, // 28: ingest.v1.IngestService.EnsureVideo:input_type -> ingest.v1.EnsureVideoRequest
	25, // 29: ingest.v1.IngestService.PreviewVideo:input_type -> ingest.v1.PreviewVideoRequest
	34, // 30: ingest.v1.IngestService.Refresh:input_type -> ingest.v1.RefreshRequest
	29, // 31: ingest.v1.IngestService.BackfillTopics:input_type -> ingest.v1.BackfillTopicsRequest
	30, // 32: ingest.v1.IngestService.GetBackfillStatus:input_type -> ingest.v1.GetBackfillStatusRequest
	36, // 33: ingest.v1.IngestService.GetScanStatus:input_type -> ingest.v1.GetScanStatusRequest
	39, // 34: ingest.v1.IngestService.ResolveStream:input_type -> ingest.v1.ResolveStreamRequest
	41, // 35: ingest.v1.IngestService.Submit:input_type -> ingest.v1.SubmitRequest
	44, // 36: ingest.v1.IngestService.GetJob:input_type -> ingest.v1.GetJobRequest
	46, // 37: ingest.v1.IngestService.ListJobs:input_type -> ingest.v1.ListJobsRequest
	48, // 38: ingest.v1.IngestService.CancelJob:input_type -> ingest.v1.CancelJobRequest
	50, // 39: ingest.v1.IngestService.DismissJob:input_type -> ingest.v1.DismissJobRequest
	52, // 40: ingest.v1.IngestService.DismissJobs:input_type -> ingest.v1.DismissJobsRequest
	54, // 41: ingest.v1.IngestService.RetryJob:input_type -> ingest.v1.RetryJobRequest
	56, // 42: ingest.v1.IngestService.ListScans:input_type -> ingest.v1.ListScansRequest
	58, // 43: ingest.v1.IngestService.ClearScans:input_type -> ingest.v1.ClearScansRequest
	60, // 44: ingest.v1.IngestService.CancelVideoDownload:input_type -> ingest.v1.CancelVideoDownloadRequest
	20, // 45: ingest.v1.IngestService.ExpandLibrary:input_type -> ingest.v1.ExpandLibraryRequest
	8,  // 46: ingest.v1.IngestService.SetAccountCookies:input_type -> ingest.v1.SetAccountCookiesRequest
	10, // 47: ingest.v1.IngestService.ListAccounts:input_type -> ingest.v1.ListAccountsRequest
	13, // 48: ingest.v1.IngestService.RemoveAccount:input_type -> ingest.v1.RemoveAccountRequest
	15, // 49: ingest.v1.IngestService.ScanAccounts:input_type -> ingest.v1.ScanAccountsRequest
	16, // 50: ingest.v1.IngestService.GetAccountScanStatus:input_type -> ingest.v1.GetAccountScanStatusRequest
	1,  // 51: ingest.v1.IngestService.ListChannelUploads:input_type -> ingest.v1.ListChannelUploadsRequest
	6,  // 52: ingest.v1.IngestService.ResolveChannel:input_type -> ingest.v1.ResolveChannelRequest
	4,  // 53: ingest.v1.IngestService.FetchSubtitles:input_type -> ingest.v1.FetchSubtitlesRequest
	63, // 54: ingest.v1.IngestService.FetchComments:input_type -> ingest.v1.FetchCommentsRequest
	24, // 55: ingest.v1.IngestService.Search:output_type -> ingest.v1.SearchResponse
	28, // 56: ingest.v1.IngestService.EnsureVideo:output_type -> ingest.v1.EnsureVideoResponse
	26, // 57: ingest.v1.IngestService.PreviewVideo:output_type -> ingest.v1.PreviewVideoResponse
	35, // 58: ingest.v1.IngestService.Refresh:output_type -> ingest.v1.RefreshResponse
	32, // 59: ingest.v1.IngestService.BackfillTopics:output_type -> ingest.v1.BackfillTopicsResponse
	33, // 60: ingest.v1.IngestService.GetBackfillStatus:output_type -> ingest.v1.GetBackfillStatusResponse
	37, // 61: ingest.v1.IngestService.GetScanStatus:output_type -> ingest.v1.GetScanStatusResponse
	40, // 62: ingest.v1.IngestService.ResolveStream:output_type -> ingest.v1.ResolveStreamResponse
	42, // 63: ingest.v1.IngestService.Submit:output_type -> ingest.v1.SubmitResponse
	45, // 64: ingest.v1.IngestService.GetJob:output_type -> ingest.v1.GetJobResponse
	47, // 65: ingest.v1.IngestService.ListJobs:output_type -> ingest.v1.ListJobsResponse
	49, // 66: ingest.v1.IngestService.CancelJob:output_type -> ingest.v1.CancelJobResponse
	51, // 67: ingest.v1.IngestService.DismissJob:output_type -> ingest.v1.DismissJobResponse
	53, // 68: ingest.v1.IngestService.DismissJobs:output_type -> ingest.v1.DismissJobsResponse
	55, // 69: ingest.v1.IngestService.RetryJob:output_type -> ingest.v1.RetryJobResponse
	57, // 70: ingest.v1.IngestService.ListScans:output_type -> ingest.v1.ListScansResponse
	59, // 71: ingest.v1.IngestService.ClearScans:output_type -> ingest.v1.ClearScansResponse
	61, // 72: ingest.v1.IngestService.CancelVideoDownload:output_type -> ingest.v1.CancelVideoDownloadResponse
	21, // 73: ingest.v1.IngestService.ExpandLibrary:output_type -> ingest.v1.ExpandLibraryResponse
	9,  // 74: ingest.v1.IngestService.SetAccountCookies:output_type -> ingest.v1.SetAccountCookiesResponse
	11, // 75: ingest.v1.IngestService.ListAccounts:output_type -> ingest.v1.ListAccountsResponse
	14, // 76: ingest.v1.IngestService.RemoveAccount:output_type -> ingest.v1.RemoveAccountResponse
	19, // 77: ingest.v1.IngestService.ScanAccounts:output_type -> ingest.v1.ScanAccountsResponse
	17, // 78: ingest.v1.IngestService.GetAccountScanStatus:output_type -> ingest.v1.GetAccountScanStatusResponse
	3,  // 79: ingest.v1.IngestService.ListChannelUploads:output_type -> ingest.v1.ListChannelUploadsResponse
	7,  // 80: ingest.v1.IngestService.ResolveChannel:output_type -> ingest.v1.ResolveChannelResponse
	5,  // 81: ingest.v1.IngestService.FetchSubtitles:output_type -> ingest.v1.FetchSubtitlesResponse
	64, // 82: ingest.v1.IngestService.FetchComments:output_type -> ingest.v1.FetchCommentsResponse
...
func file_ingest_v1_ingest_proto_init() {
	...
	file_ingest_v1_ingest_proto_msgTypes[61].OneofWrappers = []any{}
	type x struct{}
